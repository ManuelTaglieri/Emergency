...
public class Simulator {
	...
	private Duration TIMEOUT_WHITE = Duration.ofMinutes(60); //qui valori inventati, impostabili evenetualmente anche dall'utente del simulatore
	...
	public void init() {
		...
		//inizializza gli eventi di input (ARRIVAL)
